...
import com.yang.me.lib.ui.fragment.NotFoundFragment;
...
public class FragmentDisplayActivity extends BaseBindActivity<ActivityDisplayFragmentBinding> {
    ...
    protected void init() {
        ...
        try {
            ...
            BaseBindFragment<?> fragment = (BaseBindFragment<?>) clazz.newInstance();
...
//                if (fragment instanceof BaseBindFragment) {
//                    ((BaseBindFragment<?>) fragment).onBackPress(null);
//                }
//            }
            finish();
        } else {
    ...
    private static Class<? extends Fragment> getNotFoundFragmentClass() {
        ...
        try {
            fragClass = NotFoundFragment.class;
